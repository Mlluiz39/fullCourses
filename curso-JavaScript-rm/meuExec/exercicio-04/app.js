...
const my3FavoriteTvShows = ['A Sentinela', 'Cabras da Peste', 'Zona de Combate']
...
//console.log(crazyConversion)  //connverteu em true pois a soma de null a qualquer numero resulta nele mesmo, como 1 e thufy
...
//const isNotAString = typeof randomTVShow  // daminha forma
const isNotAString = typeof randomTvShow !== 'string'

//console.log(Boolean(!isNotAString))  da minha forma
...
//console.log(evenNumbers[4] === 8)  da minha forma
