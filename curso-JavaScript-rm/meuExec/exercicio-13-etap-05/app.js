...
const getCatInfo = () => {
  ...
  /* podemos retornar desta forma: ou da forma abaixo com shorthand program name
...
/* podemos refatorar o console.log desta forma: ou com Destructuring assignment.
...
/* podemos imprimir desta forma: ou da forma abaixo
...
const dogNameZequinha = dogs.find(dog => dog.name === "Zequinha")

console.log(dogNameZequinha)
...
const referenceMainTitle = document.querySelector('.main-title')

console.log(referenceMainTitle)
...
const secondaryTitleReferences = document.querySelectorAll('.secondary-title')

console.log(secondaryTitleReferences)

console.log(secondaryTitleReferences.forEach((item, index) => {
