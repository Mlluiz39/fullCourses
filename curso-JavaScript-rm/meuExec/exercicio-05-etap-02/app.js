...
//console.log(upperCaseCities)  // aqui o console está fora do bloco pq a variavel tbm está
...
for (let i = 0; i < names.length; i++) {
  HTMLTemplate += `<li>${names[i]}</li>`  // aqui poderia ser "HTMLTemplate = HTMLTemplate + `<li></li>`"
}
...
for (let i = 0; i < arrays.length; i++) {
  for (let j = 0; j < arrays[i].length; j++) {  // aqui fizemos um for aninhado para percorrer mais de um array
