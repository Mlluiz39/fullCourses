...
setTimeout(console.log, 1500, message, 'cheguei de novo')
...
const buttonStartCounter = document.querySelector('.button-init-counter')
const buttonStopCounter = document.querySelector('.button-stop-counter')
const counterContainer = document.querySelector('.counter-container')
//let counter = 0
let timer = null

buttonStartCounter.addEventListener('click', () => {
  timer = setInterval(() => {
    //counterContainer.textContent = ++counter
    counterContainer.textContent = Number( counterContainer.textContent) + 1  //conversão para number
  }, 1000);
  })
