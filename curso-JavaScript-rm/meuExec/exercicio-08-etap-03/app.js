...
*/
const info = function (value = 'Você deve passar um valor como argumento') {
  console.log(value);
};

 for (let i = 0; i < 7; i++) {
   info(`Esta é a ${i + 1}ª vez que essa string é exibida.`)
 }
/*
  04
...
const consoleNumbersInfo = `O array "randomNumbers" possui ${randomNumbers.length} números, sendo ${positiveNumbers} positivos e ${negativeNumbers} negativos.`;

console.log(consoleNumbersInfo);
