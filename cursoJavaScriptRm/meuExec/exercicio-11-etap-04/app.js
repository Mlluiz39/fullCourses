...
for (let i = 0; i < 5; i++) {
  console.log(`dentro do bloco de codigo: ${name}`)
}

console.log(`Fora do bloco de codigo: ${name}`)
...
/*
  ...
  Sim sei, foi pq a let está no escopo de bloco da funçao
*/

const showingAge = function () {
  let age = 41
  console.log(age)
}
...
let car = {
  ...
  getColorsMessage () {
    return `${this.name} está disponivel nas cores ${this.colors[0]}, ${this.colors[1]} e ${this.colors[2]}`
  }
}
