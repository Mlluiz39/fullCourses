...
*/
 ...
 const randomNumbers = [10, 30, 15, 25, 50, 40, 5, 13]
...
const countNumberLessThan501 = (accumulator, crazyNumber) => 
...
// const productList = cart.reduce((accumulator, product, index) => {
//   return `${accumulator}- Nome ${index + 1} ${product.name}\n`
// }, '')
const productList = cart.reduce((accumulator, { name }) => 
  `${accumulator}- Nome ${name}\n`, '')
...
// const moveisReleasedBefore2000 = tarantinoMovies.filter((tarantinoMovie) => 
//   tarantinoMovie.release < 2000)
const moveisReleasedBefore2000 = tarantinoMovies.filter(({ release }) =>
release < 2000)

  console.log(moveisReleasedBefore2000)
